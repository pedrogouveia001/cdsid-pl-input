object IWForm1: TIWForm1
  ...
  object rgnmatcons: TIWRegion
    ...
    object rgnmatrizdeconsequencias: TIWRegion
      Left = 24
      Top = 200
      Width = 985
      Height = 358
      ...
      object cmbbxauxiliar: TIWComboBox
        Left = 304
        Top = 18
        Width = 121
        Height = 21
  ...
  object rgnregradedecisao: TIWRegion
    Left = 2930
    Top = 800
    Width = 1360
    Height = 813
    ...
    ShowHint = True
    ZIndex = 1000
    OnCreate = rgnregradedecisaoCreate
    Splitter = False
    ...
    object IWLabel42: TIWLabel
      ...
      HasTabOrder = False
      FriendlyName = 'lblnameproblema'
      Caption = 'Additive Model - Decision Rules'
      RawText = False
    end
    ...
    object txtregradedecisao: TIWText
      Left = 48
      Top = 179
      Width = 1281
      Height = 38
      ...
      Font.Size = 11
      Font.Style = []
      FriendlyName = 'txtregradedecisao'
      Lines.Strings = (
        
          'Based on the Pareto Diagram, the most frequent solutions coverin' +
          'g 80% of occurrences were selected.')
      RawText = False
      UseFrame = False
      WantReturns = True
    end
    object grdrecomendacao: TIWGrid
      Left = 48
      Top = 242
      Width = 820
      Height = 103
    ...
    object lnkdescricaolimiar: TIWLink
      Left = 870
      Top = 668
      Width = 402
      Height = 17
      ...
      DoSubmitValidation = False
      FriendlyName = 'IWLink1'
      OnClick = lnkdescricaolimiarClick
      TabOrder = 15
      RawText = False
      Caption = 'Click to view the conceptual explanations'
    end
    object lnkregrasdedecisao: TIWLink
      Left = 530
      Top = 377
      Width = 320
      Height = 17
      ...
      DoSubmitValidation = False
      FriendlyName = 'IWLink1'
      OnClick = lnkregrasdedecisaoClick
      TabOrder = 22
      RawText = False
      Caption = 'Click to view others statistical indexes'
    end
    ...
    object IWRegion39: TIWRegion
      ...
      ZIndex = 1000
      Splitter = False
      object grdregradedecisao: TIWGrid
        Left = 1
        Top = 1
        Width = 813
        Height = 283
      ...
      object grdperdamediaemaxima: TIWGrid
        Left = 1
        Top = 1
        Width = 813
        Height = 283
        ...
        UseFrame = False
        UseSize = True
        FriendlyName = 'grdperdamediaemaxima'
        ColumnCount = 1
        RowCount = 1
        ShowEmptyCells = True
        ShowInvisibleRows = True
    ...
    object rgndescricao: TIWRegion
      ...
      object IWText7: TIWText
        ...
        Lines.Strings = (
            ...
            'The Average Loss ('#181'(Aj, Ai)) is calculated by comparing the diff' +
            'erence between a given solution and all other solutions when eac' +
            'h of the other solutions is selected. This metric quantifies the' +
            ' expected performance loss relative to the evaluated solution, p' +
            'roviding a comprehensive assessment of decision impact.'
          ''
          
            'The Average Gain ('#181'(Ai, Aj)) is calculated by comparing the diff' +
            'erence between a given solution and all other solutions when the' +
            ' evaluated solution is selected. This metric quantifies the expe' +
            'cted performance improvement relative to each alternative soluti' +
            'on, providing a comprehensive assessment of decision impact.'
          ''
          
            'The Maximum Loss (Dmax(Aj, Ai)  is determined by identifying the' +
            ' highest difference between a given solution and any of the othe' +
            'r solutions when they are selected. In other words, it represent' +
            's the greatest potential disadvantage of a solution compared to ' +
            'the others, highlighting the worst-case performance gap in the d' +
            'ecision-making process.'
          ''
          'The Global Performance of a Solution is calculated by:'
          'G(Ai)= P(Ai)*'#181'(Ai, Aj)-(1-P(Ai))*'#181'(Aj, Ai)'
          ''
          'Where,'
          'G(Ai) : Global Performance of Solution Ai;'
          'P(Ai) : Probability of Solution Ai;'
          #181'(Ai, Aj) : Average difference between Solution Ai and Aj;'
          #181'(Aj, Ai) : Average difference between Solution Aj and Ai.'
          '')
        RawText = False
        UseFrame = False
        WantReturns = True
    ...
    object rgnlimiares: TIWRegion
      ...
      ZIndex = 1000
      Splitter = False
      object txtdescricaoregra: TIWText
        Left = 3
        Top = 133
        Width = 458
        Height = 242
        ...
        FriendlyName = 'txtregradedecisao'
        Lines.Strings = (
          'NOTE: If you wish, you can change the above thresholds.'
          ''
          ''
          #949'1 > '#949'2 > '#949'3 > '#949'4'
          #969'1 > '#969'2> '#969'3> '#969'4'
          ''
          
            'To select an alternative (Ai) as a recommendation, the threshold' +
            's are defined from P(Ai).  The following constraints must be met' +
            ': '
          '[Dmax(Ay, Ai) < epsilon] and [ '#181'(Ay, Ai) < omega].'
          ''
          
            'To select two alternatives (Ai and Aj) as competitive, the thres' +
            'holds are defined from [P(Ai) + P(Aj)]. The following constraint' +
            's must be met:'
          '[Dmax(Ay, Ai) < epsilon] and [Dmax(Ay, Aj) < epsilon];'
          '['#181'(Ay, Ai) < omega] and ['#181'(Ay, Aj) < omega].'
          ''
          
            'To select three alternatives (Ai, Aj and Ak) as competitive, the' +
            ' thresholds are defined from [P(Ai) + P(Aj)+ P(Ak)]. The followi' +
            'ng constraints must be met:'
          
            '[Dmax(Ay, Ai) < epsilon] and [Dmax(Ay, Aj) < epsilon] and [Dmax(' +
            'Ay, Ak) < epsilon];'
          
            '['#181'(Ay, Ai) < omega] and ['#181'(Ay, Aj) < omega] and ['#181'(Ay, Ak) < ome' +
            'ga].')
        RawText = False
        UseFrame = False
        WantReturns = True
      end
      object btnatualizarlimiares: TIWButton
        Left = 378
        Top = 395
        Width = 75
        Height = 25
        ...
        ScriptEvents = <>
        TabOrder = 17
        OnClick = btnatualizarlimiaresClick
      end
      object IWLabel30: TIWLabel
        ...
        HasTabOrder = False
        FriendlyName = 'lblnameproblema'
        Caption = 'To view the results, click on the button:'
        RawText = False
      end
      object grdlimiares: TTIWAdvWebGrid
        Left = 3
        Top = 3
        Width = 448
        Height = 124
        ...
        Columns = <
          item
            ...
            SpinEditMaxValue = 100
            SpinEditMinValue = 0
            Title = '<FONT face="Verdana"><P align="center">Probability</P></FONT>'
            Width = 200
            SortFormat = sfAlphabetic
          end
          item
            ...
            SpinEditMinValue = 0
            Title = 
              '<FONT face="Verdana"><P align="center">Maximum Loss Threshold ('#949 +
              ')</P></FONT>'
            Width = 150
            SortFormat = sfAlphabetic
          end
          item
            ...
            SpinEditMinValue = 0
            Title = 
              '<FONT face="Verdana"><P align="center">Average Loss Threshold ('#969 +
              ')</P></FONT>'
            Width = 100
            SortFormat = sfAlphabetic
          end>
      ...
      object cmbbxp1: TIWComboBox
        ...
        Items.Strings = (
          ...
          '50')
        Sorted = False
        FriendlyName = 'cmbbxp1'
      end
      object cmbbxp2: TIWComboBox
        Left = 25
        Top = 58
        Width = 47
        Height = 21
  ...
  object rgnresultado: TIWRegion
    ...
    object IWLabel8: TIWLabel
      ...
      Caption = 'Percentage for each different solution:'
      RawText = False
    end
    object IWLabel9: TIWLabel
      ...
      HasTabOrder = False
      FriendlyName = 'IWLabel8'
      Caption = 'Combinations of criteria rankings:'
      RawText = False
    end
    ...
    object IWButton1: TIWButton
      ...
      StyleRenderOptions.RenderStatus = True
      StyleRenderOptions.RenderAbsolute = True
      Caption = 'Alternatives Detailed Results'
      DoSubmitValidation = True
      Color = clBtnFace
      Font.Color = clNone
      Font.FontName = 'verdana'
    ...
    object btnVisualizarOP: TTIWAdvToolButton
      Left = 28
      Top = 168
      Width = 213
      Height = 29
      ...
      TabOrder = 62
      BackColor = clMenuBar
      BackColorTo = clWebLIGHTGRAY
      BackColorGradientDirection = gdVertical
      BorderColor = clMenuBar
      HotColor = clWebAZURE
      HotColorTo = clNone
      HotColorGradientDirection = gdVertical
      HotBorderColor = clNone
      DownColor = clMenuBar
      DownColorTo = clNone
      DownColorGradientDirection = gdVertical
      DownBorderColor = clNone
      DisabledColor = clWebGRAY
      DisabledColorTo = clWebGRAY
      DisabledColorGradientDirection = gdVertical
      OnClick = btnVisualizarOPClick
    end
    object btnalternativa: TTIWAdvToolButton
      Left = 256
      Top = 168
      Width = 213
      Height = 29
      ...
      DisabledColorTo = clWebGRAY
      DisabledColorGradientDirection = gdVertical
      OnClick = btnalternativaClick
    end
    object TIWAdvToolButton2: TTIWAdvToolButton
      Left = 475
      Top = 168
      Width = 294
      Height = 29
      ...
      StyleRenderOptions.RenderStatus = True
      StyleRenderOptions.RenderAbsolute = True
      Text = 'Number of alternatives in POAs'
      Enabled = True
      Glyph.Stretch = False
      Glyph.Frame = 0
      Font.Color = clWebBLACK
      ...
      DownColorGradientDirection = gdVertical
      DownBorderColor = clNone
      DisabledColor = clWebSILVER
      DisabledColorTo = clWebGRAY
      DisabledColorGradientDirection = gdVertical
      OnClick = TIWAdvToolButton2Click
    end
    object rgncomparacao: TIWRegion
      Left = 44
      Top = 540
      Width = 1293
      Height = 221
      ...
      object IWLabel57: TIWLabel
        ...
        HasTabOrder = False
        FriendlyName = 'IWLabel8'
        Caption = 'Comparison between alternatives:'
        RawText = False
      end
      object grdcomparacao: TIWGrid
        Left = -19
        Top = 24
        Width = 1286
        Height = 196
    ...
    object chrtResultado: TChart
      ...
      LeftAxis.Grid.Color = 11119017
      LeftAxis.LabelsFormat.Font.Name = 'Verdana'
      LeftAxis.Maximum = 492.500000000000000000
      LeftAxis.TicksInner.Color = 11119017
      LeftAxis.Title.Font.Name = 'Verdana'
      RightAxis.Axis.Color = 4210752
      RightAxis.Grid.Color = 11119017
  ...
  object rgnalternativa: TIWRegion
    Left = 2773
    Top = -14
    Width = 1360
    Height = 746
    ...
    object IWLabel50: TIWLabel
      ...
      FriendlyName = 'IWLabel8'
      Caption = 
        'Percentage according to the number of alternatives included in t' +
        'he POA:'
      RawText = False
    end
    ...
    object IWLabel37: TIWLabel
      ...
      HasTabOrder = False
      FriendlyName = 'IWLabel8'
      Caption = 'Select the alternative to continue:'
      RawText = False
    end
    object cmbbxAlternativa: TIWComboBox
      Left = 47
      Top = 174
      Width = 248
      Height = 23
      ...
      RequireSelection = True
      ScriptEvents = <>
      OnChange = cmbbxAlternativaChange
      UseSize = True
      Style = stNormal
      ButtonColor = clBtnFace
      DoSubmitValidation = True
      ...
      ItemIndex = -1
      Sorted = False
      FriendlyName = 'cmbbxAlternativa'
    end
    object imgalternativa: TIWImage
      Left = 696
      Top = 235
      Width = 608
      Height = 426
    ...
    object IWRegion48: TIWRegion
      ...
      ZIndex = 1000
      Splitter = False
      object grdcasesalternativa: TIWGrid
        Left = 3
        Top = 1
        Width = 597
        Height = 190
  ...
  object rgnregradedecisaoPromethee: TIWRegion
    Left = 3018
    Top = 2871
    Width = 1360
    Height = 813
    ...
    ShowHint = True
    ZIndex = 1000
    OnCreate = rgnregradedecisaoprometheeCreate
    Splitter = False
    ...
    object IWLabel31: TIWLabel
      ...
      HasTabOrder = False
      FriendlyName = 'lblnameproblema'
      Caption = 'Outranking Model - Decision Rules'
      RawText = False
    end
    ...
    object txtregradedecisaopromethee: TIWText
      Left = 48
      Top = 175
      Width = 1281
      Height = 38
    ...
    object grdrecomendacaopromethee: TIWGrid
      Left = 48
      Top = 242
      Width = 820
      Height = 103
    ...
    object lnkdescricaolimiarPromethee: TIWLink
      Left = 870
      Top = 668
      Width = 402
      Height = 17
    ...
    object lnkregrasdedecisaoPromethee: TIWLink
      Left = 530
      Top = 373
      Width = 320
      Height = 17
    ...
    object rgndescricaoPromethee: TIWRegion
      Left = 870
      Top = 242
      Width = 467
      Height = 401
    ...
    object IWRegion21: TIWRegion
      ...
      ZIndex = 1000
      Splitter = False
      object grdregradedecisaopromethee: TIWGrid
        Left = 1
        Top = 1
        Width = 813
        Height = 283
      ...
      object grdperdamediaemaximapromethee: TIWGrid
        Left = 1
        Top = 1
        Width = 813
        Height = 283
    ...
    object rgnlimiaresPromethee: TIWRegion
      Left = 870
      Top = 242
      Width = 467
      Height = 409
      ...
      ZIndex = 1000
      Splitter = False
      object btnatualizarlimiaresPromethee: TIWButton
        Left = 378
        Top = 375
        Width = 75
        Height = 25
      ...
      object txtdescricaoregraPromethee: TIWText
        Left = 1
        Top = 133
        Width = 458
        Height = 236
      ...
      object grdlimiarespromethee: TTIWAdvWebGrid
        Left = 4
        Top = 7
        Width = 449
        Height = 120
      ...
      object cmbbxp1promethee: TIWComboBox
        Left = 25
        Top = 41
        Width = 47
        Height = 21
      ...
      object lblp1promethee: TIWLabel
        Left = 78
        Top = 42
        Width = 64
        Height = 16
      ...
      object cmbbxp2promethee: TIWComboBox
        Left = 25
        Top = 63
        Width = 47
        Height = 21
      ...
      object cmbbxp3promethee: TIWComboBox
        Left = 25
        Top = 84
        Width = 47
        Height = 21
      ...
      object cmbbxp4promethee: TIWComboBox
        Left = 25
        Top = 106
        Width = 47
        Height = 21
      ...
      object lblp2promethee: TIWLabel
        Left = 78
        Top = 62
        Width = 123
        Height = 16
      ...
      object lblp3promethee: TIWLabel
        Left = 78
        Top = 85
        Width = 123
        Height = 16
      ...
      object lblp4promethee: TIWLabel
        Left = 78
        Top = 107
        Width = 123
        Height = 16
  ...
  object rgnintro: TIWRegion
    ...
    object imgSolve: TIWImage
      ...
      UseSize = True
      Picture.Data = {
        
        ...
        
        2590670EE5867DCD145007FFD9}
      FriendlyName = 'imgSolve'
      TransparentColor = clNone
      JpegOptions.CompressionQuality = 90
      JpegOptions.Performance = jpBestSpeed
      JpegOptions.ProgressiveEncoding = False
  ...
  object rgnEnterLogin: TIWRegion
    ...
    object lnkbacklogin: TIWLink
      ...
      ScriptEvents = <>
      DoSubmitValidation = False
      FriendlyName = 'lnkbacklogin'
      OnClick = lnkbackloginClick
      TabOrder = 43
      RawText = False
      Caption = '<< Back'
    end
  ...
  object rgnanaliseestatistica: TIWRegion
    Left = 1512
    Top = 1600
    Width = 1360
    Height = 713
    ...
    ShowHint = True
    ZIndex = 1000
    OnCreate = rgnanaliseestatisticaCreate
    Splitter = False
    ...
    object IWLabel16: TIWLabel
      ...
      HasTabOrder = False
      FriendlyName = 'lblnameproblema'
      Caption = 'Statistical Analysis of Alternatives'
      RawText = False
    end
    ...
    object IWText1: TIWText
      ...
      Lines.Strings = (
          ...
          'Note: The table above is a statistical analysis of the different' +
          ' solutions found for the decision problem. In this way, it is po' +
          'ssible to visualize the difference between the performance of a ' +
          'Si solution (represented by each row) and the performance of an ' +
          'Sj solution (represented by each column) for the cases in which ' +
          'the solution chosen was Si.')
      RawText = False
      UseFrame = False
      WantReturns = True
    end
    ...
    object IWText8: TIWText
      ...
      Lines.Strings = (
          ...
          'The max-min decision is the one with the highest minimum differe' +
          'nce compared to the others. In other words, it is the one with t' +
          'he greatest minimum advantage over the others.')
      RawText = False
      UseFrame = False
      WantReturns = True
    end
    ...
    object IWLink13: TIWLink
      ...
      TabOrder = 61
      RawText = False
      Caption = 'Visualize Decision Rules for the Best Solutions'
    end
  ...
  object rgndetalhamentoalt: TIWRegion
    Left = 1506
    Top = 800
    Width = 1360
    Height = 713
    ...
    ShowHint = True
    ZIndex = 1000
    OnCreate = rgndetalhamentoaltCreate
    Splitter = False
    ...
    object IWText2: TIWText
      ...
      Lines.Strings = (
        #956': Mean;'
        'Vmax: Max. Global Value'
        'Vmin: Min. Global Value')
      RawText = False
      UseFrame = False
      WantReturns = True
    end
    object lnkExportar: TIWLink
      Left = 1192
      Top = 89
      Width = 125
      Height = 17
    ...
    object IWLabel5: TIWLabel
      ...
      HasTabOrder = False
      FriendlyName = 'lblnameproblema'
      Caption = 'Statistical Indexes of alternatives:'
      RawText = False
    end
    object IWLabel6: TIWLabel
      ...
      HasTabOrder = False
      FriendlyName = 'lblnameproblema'
      Caption = 'Pairwise Comparison - Probability of win:'
      RawText = False
    end
    object IWLabel15: TIWLabel
      ...
      FriendlyName = 'lblnameproblema'
      Caption = 
        'The probability of win is the probability of an alternative Ai (' +
        'Line) be better than an alternative Aj (Column)'
      RawText = False
    end
    ...
    object IWRegion16: TIWRegion
      ...
      ZIndex = 1000
      Splitter = False
      object grdestatisticaalternativa: TIWGrid
        Left = 1
        Top = 1
        Width = 1269
        Height = 340
